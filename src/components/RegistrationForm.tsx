  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <motion.div
        ...
        className="glass rounded-xl p-6 md:p-8 shadow-lg"
      >
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <AnimatePresence mode="wait">
              {gender && (
                ...
                >
                  <h3 className="text-lg font-semibold mb-4">Select Your Event</h3>
            ...
            >
              <Button 
                ...
                className="w-full md:w-auto px-8 py-6 bg-festival-blue hover:bg-blue-600 text-white rounded-lg shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/30 transition-all"
              >
                {isSubmitting ? (
                  <>
